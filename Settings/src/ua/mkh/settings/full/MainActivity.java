	   ...
	   /////DATABASE     
	       ...
	       if (mSettings.contains(APP_PREFERENCES_text_size)) {
				...
				if (size.contains("Small")){
					btn_avia.setTextSize(14);
					btn_wifi.setTextSize(14);
					
					if(bt != null){
					btn_bluetooth.setTextSize(14);
					textbt.setTextSize(14);
					}
					btn_battery.setTextSize(14);
					btn_sota.setTextSize(14);
					btn_operator.setTextSize(14);
					btn_osnova.setTextSize(14);
					btn_passcode.setTextSize(14);
					btn_privacy.setTextSize(14);
					btn_zvuki.setTextSize(14);
					btn_oboi.setTextSize(14);
					btn_notification.setTextSize(14);
					btn_control.setTextSize(14);
					btn_disturb.setTextSize(14);
					btn_gps.setTextSize(14);	
					btn_mail.setTextSize(14);
					btn_notes.setTextSize(14);	
					btn_messages.setTextSize(14);
					...
					btn_games.setTextSize(14);
					btn_new1.setTextSize(14);
					btn_new2.setTextSize(14);
					btn_new3.setTextSize(14);
					btn_new4.setTextSize(14);
					btn_vpn.setTextSize(14);
					btn_display.setTextSize(14);
					textwifi.setTextSize(14);
					TextOper.setTextSize(14);
					btn_iCloud.setTextSize(14);
					btn_iTunes.setTextSize(14);
				...
				if (size .contains( "Normal")){
					btn_avia.setTextSize(16);
					btn_wifi.setTextSize(16);
					
					if(bt != null){
					btn_bluetooth.setTextSize(16);
					textbt.setTextSize(16);
					}
					btn_battery.setTextSize(16);
					btn_sota.setTextSize(16);
					btn_operator.setTextSize(16);
					btn_osnova.setTextSize(16);
					btn_passcode.setTextSize(16);
					btn_privacy.setTextSize(16);
					btn_zvuki.setTextSize(16);
					btn_oboi.setTextSize(16);
					btn_notification.setTextSize(16);
					btn_control.setTextSize(16);
					btn_disturb.setTextSize(16);
					btn_gps.setTextSize(16);	
					btn_mail.setTextSize(16);
					btn_notes.setTextSize(16);	
					btn_messages.setTextSize(16);
					...
					btn_games.setTextSize(16);
					btn_new1.setTextSize(16);
					btn_new2.setTextSize(16);
					btn_new3.setTextSize(16);
					btn_new4.setTextSize(16);
					btn_vpn.setTextSize(16);
					btn_display.setTextSize(16);
					textwifi.setTextSize(16);
					TextOper.setTextSize(16);
					btn_iCloud.setTextSize(16);
					btn_iTunes.setTextSize(16);
				...
				if (size .contains("Large")){
					btn_avia.setTextSize(19);
					btn_wifi.setTextSize(19);
					
					if(bt != null){
					btn_bluetooth.setTextSize(19);
					textbt.setTextSize(19);
					}
					btn_battery.setTextSize(19);
					btn_sota.setTextSize(19);
					btn_operator.setTextSize(19);
					btn_osnova.setTextSize(19);
					btn_passcode.setTextSize(19);
					btn_privacy.setTextSize(19);
					btn_zvuki.setTextSize(19);
					btn_oboi.setTextSize(19);
					btn_notification.setTextSize(19);
					btn_control.setTextSize(19);
					btn_disturb.setTextSize(19);
					btn_gps.setTextSize(19);	
					btn_mail.setTextSize(19);
					btn_notes.setTextSize(19);	
					btn_messages.setTextSize(19);
					...
					btn_games.setTextSize(19);
					btn_new1.setTextSize(19);
					btn_new2.setTextSize(19);
					btn_new3.setTextSize(19);
					btn_new4.setTextSize(19);
					btn_vpn.setTextSize(19);
					btn_display.setTextSize(19);
					textwifi.setTextSize(19);
					TextOper.setTextSize(19);
					btn_iCloud.setTextSize(19);
					btn_iTunes.setTextSize(19);
				...
				if (size .contains("xLarge")){
					btn_avia.setTextSize(21);
					btn_wifi.setTextSize(21);
					
					if(bt != null){
					btn_bluetooth.setTextSize(21);
					textbt.setTextSize(21);
					}
					btn_battery.setTextSize(21);
					btn_sota.setTextSize(21);
					btn_operator.setTextSize(21);
					btn_osnova.setTextSize(21);
					btn_passcode.setTextSize(21);
					btn_privacy.setTextSize(21);
					btn_zvuki.setTextSize(21);
					btn_oboi.setTextSize(21);
					btn_notification.setTextSize(21);
					btn_control.setTextSize(21);
					btn_disturb.setTextSize(21);
					btn_gps.setTextSize(21);	
					btn_mail.setTextSize(21);
					btn_notes.setTextSize(21);	
					btn_messages.setTextSize(21);
					...
					btn_games.setTextSize(21);
					btn_new1.setTextSize(21);
					btn_new2.setTextSize(21);
					btn_new3.setTextSize(21);
					btn_new4.setTextSize(21);
					btn_vpn.setTextSize(21);
					btn_display.setTextSize(21);
					textwifi.setTextSize(21);
					TextOper.setTextSize(21);
					btn_iCloud.setTextSize(21);
					btn_iTunes.setTextSize(21);
